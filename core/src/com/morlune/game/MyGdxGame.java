...
public class MyGdxGame extends ApplicationAdapter {
	...
	public void create () {
		...
		RectangleRaton = new Rectangle(ratonX, height - ratonY, 10, 10); //instanciar rectangulo colision raton

		background = new Texture("town.png");
	}
	...
	public void render () {
		...
		if (RectangleRaton.overlaps(city.getRectangleCity())) {
		...
		RectangleRaton.setY(height - ratonY);
	}
